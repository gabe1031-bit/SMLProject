...
The website edition of this extension for this project is coming soon! Please wait for the current edition to roll out to its final release, so the website could be added accordingly with the release update. Thank you for supporting the release of this extension!

# Project Installation and View Types

Use the link shown here: [https://scribehow.com/viewer/Download_SML_Extension_BETA_Source_Code__Gqft05QfRF2p1568-Jtg6Q](url) to install via Developer Mode. (Managed devices can **NOT** install this extension through this method.)  
...
The website is now online! It is published at http://thesmlproject.dpdns.org/ . If the website could not be accessed at that link, try the Github Pages alternative; https://gabe1031-bit.github.io/SMLProject/ . (although they both lead to .dpdns)
